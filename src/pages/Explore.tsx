...
const Header = styled.div`display:flex; align-items:center; justify-content:space-between; margin-bottom:1rem;`;
    ...
    return (
        <Page>
            <Header>
                ...
                <Btn variant="ghost" onClick={() => navigate(me ? `/profile/${me}` : "/")}>
                    Voltar ao perfil
                </Btn>
            </Header>
            <Card>
